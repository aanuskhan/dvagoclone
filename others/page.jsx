...
export default function other() {
  ...
  async function fetchOtherProducts() {
    ...
    const { data, error } = await supabase
      .from("product")
      .select("*")
      .contains("store_categories", ["others"])
  ...
  const handleAddToCart = (product) => {
    if (!user?.loggedIn) {
      localStorage.setItem("redirect_after_login", "/others");
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-screen-xl mx-auto px-4 py-6">
          ...
          <div className="flex items-center gap-2 mb-6">
            ...
            <h1 className="text-2xl font-semibold text-gray-700">Others</h1>
          </div>
      ...
      <div className="bg-white border-t border-gray-200 mt-12">
        <div className="max-w-screen-xl mx-auto px-4 py-10">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">
            Buy Machines,BabyCare Online at Best Prices in Pakistan
          </h1>
          <p className="text-gray-600 text-sm leading-relaxed mb-8">
            Looking for high-quality Machines,BabyCare at the best prices? At{" "}
            <Link
              href="/"
            ...
            Machines,BabyCare to meet all your health needs. Whether you're
            looking to{" "}
            <Link
            ...
            prices. Buy Machines,BabyCare online in Pakistan now, and start your
          ...
          <ul className="space-y-2 mb-8 text-sm text-gray-600">
            ...
            <li className="flex gap-2">
              <span className="text-[#76bc21] font-bold">•</span>
              <span>
                <strong>Blood pressure Measure:</strong> Dissolve in water for a
                fizzy, refreshing, and easily digestible option.
              </span>
            </li>
          </ul>
          <p className="text-gray-600 text-sm mb-8">
            Find your perfect Machines,BabyCare form at{" "}
            <Link
              href="/"
              className="text-[#76bc21] hover:underline font-semibold"
            >
          ...
          <p className="text-gray-600 text-sm mb-8">
            With Dvago, you'll find the right Machines,BabyCare to match your
            age, gender, and unique health needs.
          </p>
          ...
          <p className="text-gray-600 text-sm mb-4">
            Find Machines,BabyCare that target your specific health goals. Our
          ...
          <ul className="space-y-2 mb-8 text-sm text-gray-600">
            <li className="flex gap-2">
              ...
              <span>
                ...
                with Machines,BabyCare designed to fight off illness and keep
                you healthy.
              </span>
            </li>
            <li className="flex gap-2">
