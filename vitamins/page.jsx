      ...
      <div className="bg-white border-t border-gray-200 mt-12">
        <div className="max-w-screen-xl mx-auto px-4 py-10">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">
            Buy Multivitamins Online at Best Prices in Pakistan
          </h1>
          <p className="text-gray-600 text-sm leading-relaxed mb-8">
            Looking for high-quality vitamins at the best prices? At{" "}
            <Link
              href="/"
          ...
          <p className="text-gray-600 text-sm mb-8">
            Find your perfect vitamins form at{" "}
            <Link
              href="/"
              className="text-[#76bc21] hover:underline font-semibold"
            >
          ...
          {/* By Age & Gender */}
          <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-3">
            Multivitamins by Age & Gender
          </h2>
          <p className="text-gray-600 text-sm mb-4">
            Whether you're looking for vitamins for yourself or a loved one,
          ...
          <ul className="space-y-2 mb-4 text-sm text-gray-600">
            ...
            <li className="flex gap-2">
              <span className="text-[#76bc21] font-bold">•</span>
              <span>
                <strong>MultiVitamins for Seniors:</strong> Aimed at maintaining{" "}
                <Link
                  href="/bone-health"
                  className="text-[#76bc21] hover:underline"
                >
